...
<head>
      ...
      <!-- Bootstrap 3.3.7 -->
      <link rel="stylesheet" href="{{ asset('plugins/AdminLTE-2.4.5/bower_components/bootstrap/dist/css/bootstrap.min.css') }}">
      <!-- Font Awesome -->
      <!-- <link rel="stylesheet" href="{{ asset('plugins/AdminLTE-2.4.5/bower_components/font-awesome/css/font-awesome.min.css') }}"> -->
      ...
      <!-- Date Picker -->
      <link rel="stylesheet" href="{{ asset('plugins/AdminLTE-2.4.5/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
      <!-- Daterange picker -->
      <link rel="stylesheet" href="{{ asset('plugins/AdminLTE-2.4.5/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}">
